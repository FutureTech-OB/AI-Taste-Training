...
MODELS="ft:gpt-4.1-2025-04-14:personal:ob-ob-rqcontext:DHnLrzmY"
[ -n "$1" ] && MODELS="$1"

PROVIDER="openai.official"
TEMPERATURE="${2:-0.0}"        # $2: temperature (default 0)
MAX_CONCURRENT="${3:-20}"      # $3: max concurrent requests
THINKING_MODEL="${4:-False}"   # $4: is the model a thinking model (True/False)
ENABLE_THINKING="${5:-False}"  # $5: enable thinking output  (True/False)
